...
<Tabs syncKey="framework">
  ...
  <TabItem label="SolidStart">
    ...
    In Solid, `session` is an [InitializedResource](https://docs.solidjs.com/reference/basic-reactivity/create-resource#resource). Call it as a function to get the value, and access `.loading` or `.state` for loading states.
  </TabItem>
</Tabs>
